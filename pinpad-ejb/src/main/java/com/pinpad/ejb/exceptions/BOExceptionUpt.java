...
public class BOExceptionUpt extends Exception {
	...
	public BOExceptionUpt() {
		super();
	}

	public BOExceptionUpt(String codeMessage, Throwable cause) {
		super(MensajesUtil.getMensaje(codeMessage, localeDefault), cause);
		this.codeMessage = codeMessage;
	}

	public BOExceptionUpt(String codeMessage) {
		super(MensajesUtil.getMensaje(codeMessage, localeDefault));
		this.codeMessage = codeMessage;
	}

	public BOExceptionUpt(Throwable cause) {
		super(cause);
	}

	public BOExceptionUpt(String codeMessage, @NotNull Object data) {
		super(MensajesUtil.getMensaje(codeMessage, localeDefault));
		this.codeMessage = codeMessage;
		this.data = data;
	}

	public BOExceptionUpt(String codeMessage, @NotNull Object[] messageParametersValues, Throwable cause) {
	...
	public BOExceptionUpt(String codeMessage, @NotNull Object[] messageParametersValues) {
		super(MensajesUtil.getMensaje(codeMessage, messageParametersValues, localeDefault));
		this.codeMessage = codeMessage;
		this.messageParametersValues = messageParametersValues;
	}

	public BOExceptionUpt(String codeMessage, @NotNull Object[] messageParametersValues, @NotNull Object data) {
		super(MensajesUtil.getMensaje(codeMessage, messageParametersValues, localeDefault));
		this.codeMessage = codeMessage;
		this.messageParametersValues = messageParametersValues;
		this.data = data;
